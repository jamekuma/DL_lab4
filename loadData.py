...
def get_dataset(pos_file, neg_file, dict, shuffle=True):
    ...
    train_target = [1 for _ in range(len(pos_set) - 1000)] + [1 for _ in range(len(neg_set) - 1000)]
    test_data = pos_set[-1000:] + neg_set[-1000:]
    test_target = [1 for _ in range(1000)] + [1 for _ in range(1000)]
    ...
    if shuffle:
        ...
        return train_data_shuffle, train_target_shuffle, test_data, test_target
    else:
